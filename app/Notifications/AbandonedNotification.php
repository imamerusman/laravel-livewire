...
class AbandonedNotification extends Notification implements ShouldQueue
{
    use Queueable, Dispatchable;

    public function __construct(protected OtherNotification $notification, protected CartAbandonmentEvent $event)
    {
        if ($this->notification->type !== NotificationTypes::AbandonedCartReminder) {
            throw new InvalidArgumentException('Notification must be of type abandoned .');
        }
    }
